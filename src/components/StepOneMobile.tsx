    ...
    <div className="bg-tertiary">
      <div className="flex flex-col items-center justify-between max-w-screen-md mx-auto h-screen md:h-none bg-tertiary p-5 relative">
        ...
        <div className="flex justify-end items-center w-full mb-4">
          <img src={logo} alt="Logo" className="w-[35px] hidden h-[35px]" />
          <p onClick={handleSkip} className="text-white cursor-pointer mb-[1.2rem] mt-[1rem] flex justify-end items-end font-normal">
            Skip
          </p>
        </div>
